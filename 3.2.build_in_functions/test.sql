...
VALUES
	...
	('BR', NULL, 'Brazil', 'BRL', 'SA', 201103330, 8511965, 'BrasГ­lia'),
	...
	('CO', NULL, 'Colombia', 'COP', 'SA', 47790000, 1138910, 'BogotГЎ'),
...
VALUES
	...
	('ParanГЎ', 4880, 2582672, 18000, 'RГ­o de la Plata'),
	...
	('PurГєs', 3211, 63166, 8400, 'Amazon'),
	('Yukon', 3185, 850000, 6210, 'Bering Sea'),
	('Indus', 3180, 960000, 7160, 'Arabian Sea'),
	('SГЈo Francisco', 3180, 610000, 3300, 'Atlantic Ocean'),
